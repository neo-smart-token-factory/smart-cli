...
> Este documento descreve o **plano de execução** para migrar de monorepo para arquitetura multi-repo.  
> **Estrutura atual (v0.5.1)**: Monorepo (`neo-smart-factory`) com `forge-*`  
> **Veja**: [Arquitetura](arquitetura.md) para visão completa | [Repositórios](repos.md) para catálogo

---

## 🎯 Objetivo: Da Estrutura Monorepo Atual para Arquitetura Modular
